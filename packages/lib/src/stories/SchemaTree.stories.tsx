...
const withSchemaContext = (Story: ComponentType) => (
  <AsyncAPIDocumentContext.Provider
    value={{ specType: "asyncapi", document: mockDocument as unknown as AsyncAPIDocumentData, deref, portalHost: null, rootElement: null, depthColors: DEFAULT_DEPTH_COLORS, showExtensions: true }}
  >
