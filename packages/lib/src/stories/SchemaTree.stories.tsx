...
const withSchemaContext = (Story: ComponentType) => (
  <AsyncAPIDocumentContext.Provider
    value={{ specType: "asyncapi", document: mockDocument as unknown as AsyncAPIDocumentData, deref, portalHost: null, rootElement: null, sidePanelContainment: "component", resolvedMode: "light", depthColors: DEFAULT_DEPTH_COLORS, showExtensions: true, showCodeSamples: true }}
  >
    <div className="apiuikit-root relative @container bg-background text-foreground mx-auto w-full max-w-3xl p-4">
      <Story />
    </div>
  </AsyncAPIDocumentContext.Provider>
);
